...
export class RegistroComponent implements OnInit {
  ...
  registerForm = new FormGroup({
    nombreCompleto: new FormControl('', [Validators.required, Validators.pattern("[a-zA-Z ]{0,254}")]), //validacion que solo permita letras y espacios rango de 0-244 caracteres
